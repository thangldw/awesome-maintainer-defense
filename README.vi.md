...
| --- | --- | --- |
| Dự án bình thường, ít thời gian | Dùng [balanced starter kit](kits/balanced) | Thêm issue form và tự động hóa vòng đời |
...
Đọc [audit tài nguyên](docs/RESOURCE_AUDIT.md), [phương pháp đánh giá](docs/EVALUATION.md), [threat model](docs/THREAT_MODEL.md) và [playbook tiếng Việt](docs/vi/PLAYBOOK.md) trước khi áp dụng.
