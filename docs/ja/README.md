...
英語版が製品契約の正本です。日本語版は、監査の開始、安全上の制約、防御策の運用、パイロット参加に必要な要点を提供します。

| 目的 | ドキュメント |
| --- | --- |
| 最初の監査を実行する | [はじめに](GETTING_STARTED.md) |
| 信頼境界と制約を理解する | [安全性](SAFETY.md) |
| トリアージ、承認、展開、ロールバック | [プレイブック](PLAYBOOK.md) |
